...
const { handler } = require("./build/lambda/services/learning-service/src/handler.js");
const { ROUTES } = require("./build/lambda/services/learning-service/src/routes.js");
...
server.listen(PORT, () => {
  console.log(`learning-service local server is running at http://localhost:${PORT}`);
});
