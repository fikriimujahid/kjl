...
import { Container, SectionBadge } from './shared';
...
export function CTASection() {
  return (
    <section className="py-32 px-4 bg-gradient-to-br from-indigo-950 via-slate-900 to-slate-950 relative overflow-hidden flex justify-center">
      ...
      <Container className="max-w-3xl w-full text-center">
        <SectionBadge
          label="Bergabung Sekarang"
          className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 border border-white/20 rounded-full justify-center mb-8"
          labelClassName="text-xs font-bold text-white/80 uppercase tracking-widest"
