...
export default function Home() {
  ...
  return (
    <div className="overflow-hidden bg-white">
      ...
      {/* ── HERO — dark, immersive, Japan-accented ── */}
      <section className="relative pt-32 pb-28 md:pt-44 md:pb-36 px-4 bg-slate-950 overflow-hidden text-center flex flex-col items-center">
        ...
        {/* Floating kanji — purely decorative */}
      ...
      <section className="py-24 px-4 bg-slate-50 border-b border-slate-100 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            ...
            <Link to="/products" className="px-6 py-3 bg-white border border-slate-200 rounded-xl font-bold text-sm text-slate-700 hover:bg-slate-50 transition-all shadow-sm flex items-center gap-2 shrink-0">
          ...
          <div className="mt-12 text-center">
            <Link to="/products" className="inline-flex items-center gap-2 text-indigo-600 font-bold hover:text-indigo-700 transition-colors">
      ...
      {/* ── KEUNGGULAN — dark section for contrast rhythm ── */}
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
            {[
              ...
              <div key={i} className="bg-white/5 backdrop-blur-sm p-8 rounded-3xl border border-white/10 hover:bg-white/10 hover:border-indigo-400/30 hover:-translate-y-1 transition-all duration-300">
        ...
        <div className="max-w-7xl w-full mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm hover:shadow-xl hover:border-indigo-100 hover:-translate-y-1 transition-all duration-300 flex flex-col">
                <div className="flex gap-0.5 mb-5">
                  {Array.from({ length: 5 }).map((_, s) => (
                    <span key={s} className="text-amber-400 text-base">★</span>
                  ))}
                </div>
                <p className="mb-8 font-medium leading-relaxed text-slate-600 flex-1">"{t.text}"</p>
      ...
      <section className="py-32 px-4 bg-gradient-to-br from-indigo-950 via-slate-900 to-slate-950 relative overflow-hidden flex justify-center">
        ...
        <div className="max-w-3xl w-full relative z-10 text-center">
          ...
          <Link to="/register" className="inline-flex items-center gap-2 px-10 py-5 bg-white text-slate-900 rounded-xl font-bold transition-all shadow-2xl hover:bg-slate-50 text-lg hover:-translate-y-1">
