      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            <li><Link href="/products" className="hover:text-indigo-400 transition-colors">Semua Produk</Link></li>
            <li><Link href="/register" className="hover:text-indigo-400 transition-colors">Daftar Akun</Link></li>
            <li><Link href="/faq" className="hover:text-indigo-400 transition-colors flex items-center gap-2"><HelpCircle size={14} /> Bantuan & FAQ</Link></li>
          </ul>
        </div>
