...
#   description = "Google OAuth client ID used by the Cognito Google identity provider."
#   type        = string
# }

# variable "google_client_secret" {
#   description = "Google OAuth client secret used by the Cognito Google identity provider."
#   type        = string
#   sensitive   = true
# }
